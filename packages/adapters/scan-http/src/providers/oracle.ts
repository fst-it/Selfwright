...
//
// LIVE-VERIFIED 2026-07-13 against jpmc.fa.oraclecloud.com (JP Morgan Chase, CX_1001):
//   endpoint returned items[] with Id/Title/PrimaryLocation/ShortDescriptionStr confirmed;
//   7,140 total positions in index.
